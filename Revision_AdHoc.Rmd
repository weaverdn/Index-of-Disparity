...
```{r Dominant Industry Thresholds}

# Let's figure out what percentile 28.7% is among the CSDs in each year:
...
```{r First Nation Data Quality, warning=FALSE}
...
```{r Regional and Characteristic Analysis of Missing CSDs.}
